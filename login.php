        ...
        <div class="card p-4">
          <div class="card-body">
            ...
            <div class="row">
              ...
              <div class="col-md-12 wow fadeInUp" data-wow-duration="1s" data-wow-delay="1.3s">
                <div class="form-group">
                  <a href="regestration_failed.php" style="text-decoration: none"><button type="button" class="btn btn-outline-danger btn-block">Login</button></a>
                </div>
              </div>
            </div>
